 ...
 *  @generated
 */
package com.github.sofn.trpc.demo;
...
public class Hello {
  ...
  public interface Iface extends com.facebook.fb303.FacebookService.Iface {
    ...
    public String hi(String name) throws org.apache.thrift.TException;

  }

  public interface AsyncIface extends com.facebook.fb303.FacebookService .AsyncIface {

    public void hi(String name, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends com.facebook.fb303.FacebookService.Client implements Iface {
    ...
    public void send_hi(String name) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends com.facebook.fb303.FacebookService.AsyncClient implements AsyncIface {
    ...
    public void hi(String name, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      hi_call method_call = new hi_call(name, resultHandler, this, ___protocolFactory, ___transport);
    ...
    public static class hi_call extends org.apache.thrift.async.TAsyncMethodCall {
      private String name;
      public hi_call(String name, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
  ...
  public static class Processor<I extends Iface> extends com.facebook.fb303.FacebookService.Processor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class hi<I extends Iface> extends org.apache.thrift.ProcessFunction<I, hi_args> {
      ...
      public hi_result getResult(I iface, hi_args args) throws org.apache.thrift.TException {
        hi_result result = new hi_result();
        result.success = iface.hi(args.name);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends com.facebook.fb303.FacebookService.AsyncProcessor<I> {
    ...
    public static class hi<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, hi_args, String> {
      ...
      public void start(I iface, hi_args args, org.apache.thrift.async.AsyncMethodCallback<String> resultHandler) throws TException {
        iface.hi(args.name,resultHandler);
      }
    }
  ...
  public static class hi_args implements org.apache.thrift.TBase<hi_args, hi_args._Fields>, java.io.Serializable, Cloneable, Comparable<hi_args>   {
    ...
    public hi_args setName(String name) {
      this.name = name;
      return this;
    }
